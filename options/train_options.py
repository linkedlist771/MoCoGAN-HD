...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument(
            "--l_len", type=int, default=256, help="size of logits in contrastive loss"
        )
        self.parser.add_argument(
            "--moco_m",
            default=0.999,
        ...
        self.parser.add_argument(
            "--moco_t", default=0.07, type=float, help="softmax temperature"
        )
        self.parser.add_argument(
            "--w_match", default=1.0, type=float, help="the weight for feat match loss"
        )
        ...
        self.parser.add_argument(
            "--G_step", type=int, default=5, help="number of training iterations for G"
        )
        self.parser.add_argument(
            "--total_epoch", type=int, default=5, help="training epochs"
        )
        ...
        self.parser.add_argument(
            "--nc", type=int, default=3, help="# of input channels for D_3d"
        )
